      ...
      <Card className="overflow-hidden transition-all hover:shadow-lg h-full">
        <CardHeader className="p-6">
          ...
          <CardTitle className="text-xl">
            {service.title}
            {service.comingSoon && <span className="text-gray-400 text-base ml-1">(coming soon)</span>}
          </CardTitle>
            ...
            <div className="grid gap-6 lg:grid-cols-2 lg:gap-12 items-center">
              <div className="flex flex-col justify-center space-y-4">
                <div className="inline-block rounded-lg bg-blue-100 px-3 py-1 text-sm text-blue-800">
                  Clinical Data Analysis Made Simple
                </div>
                <h1 className="text-3xl font-bold tracking-tighter sm:text-4xl md:text-5xl lg:text-6xl">
                  Transform Clinical Data Without Writing a Single Line of Code
                </h1>
                <p className="max-w-[600px] text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                  ROX combines AI and R language expertise to streamline clinical data analysis, statistical modeling,
              ...
              <div className="flex justify-center">
                <div className="relative w-full max-w-[500px] aspect-video rounded-xl overflow-hidden shadow-2xl transform transition-all duration-300 hover:scale-105 hover:shadow-xl">
                  <img
                    ...
                    alt="Medical data analysis visualization showing charts and graphs"
